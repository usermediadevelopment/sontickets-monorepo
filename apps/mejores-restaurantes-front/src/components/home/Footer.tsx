...
export function Footer() {
  return (
    <footer className="border-t bg-background container mx-auto px-4 py-16">
      <div className="container py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-medium">Mejores Restaurantes</h3>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-between items-center border-t pt-6 gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Mejores Restaurantes. All rights reserved.
          </p>
