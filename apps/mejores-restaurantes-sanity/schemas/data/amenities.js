...
export const facilitiesOptions = [
  {title: 'Wi-Fi gratuito', value: 'wi-fi gratuito'},
  {title: 'Reservación en línea', value: 'reservación en línea'},
  {title: 'Servicio de bar completo', value: 'servicio de bar completo'},
  {title: 'Carta de vinos', value: 'carta de vinos'},
...
export const entertainmentOptions = [
  {title: 'Música en vivo', value: 'música en vivo'},
  {title: 'Música de DJ', value: 'música de dj'},
  {title: 'Happy hour', value: 'happy hour'},
  {title: 'Eventos temáticos', value: 'eventos temáticos'},
  {title: 'Proyección de deportes en vivo', value: 'proyección de deportes en vivo'},
  {title: 'Karaoke', value: 'karaoke'},
  {title: 'Shows de comedia', value: 'shows de comedia'},
  {title: 'Noches de trivia', value: 'noches de trivia'},
  {title: 'Música ambiente', value: 'música ambiente'},
]

export const suitableForOptions = [
  {title: 'Grupos grandes', value: 'grupos grandes'},
  {title: 'Reuniones familiares', value: 'reuniones familiares'},
  {title: 'Citas románticas', value: 'citas románticas'},
  {title: 'Eventos corporativos', value: 'eventos corporativos'},
  {title: 'Celebraciones de cumpleaños', value: 'celebraciones de cumpleaños'},
  {title: 'Bodas', value: 'bodas'},
  {title: 'Despedidas de soltero/a', value: 'despedidas de soltero/a'},
  {title: 'Comidas de negocios', value: 'comidas de negocios'},
  {title: 'Viajeros en solitario', value: 'viajeros en solitario'},
  {title: 'Ambiente solo para adultos', value: 'ambiente solo para adultos'},
  {title: 'Ambiente estudiantil', value: 'ambiente estudiantil'},
  {title: 'Espacio para networking', value: 'espacio para networking'},
]

export const paymentOptions = [
  {title: 'Acepta pagos con tarjeta de credito', value: 'acepta pagos con tarjeta de credito'},
  {title: 'Acepta pagos con tarjeta debito', value: 'acepta pagos con tarjeta debito'},
  ...
  {title: 'Pago en efectivo', value: 'pago en efectivo'},
]
